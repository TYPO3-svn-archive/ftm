 ...
 * @subpackage    ftm
 */
class TypoScriptSnippetLoadRow {
    ...
    public function renderField(array &$parameters, &$parentObject) {
        ...
        if(@file_exists($snippetFolder.'typoScriptSnippets.serialized')) {
            ...
            if(is_array($snippetsArray) && !empty($snippetsArray)) {
                ...
                $snippetOwnLabel = \TYPO3\CMS\Extbase\Utility\LocalizationUtility::translate($langPrefix."own_snippets", "Ftm");
                $snippetOtherLabel = \TYPO3\CMS\Extbase\Utility\LocalizationUtility::translate($langPrefix."foreign_snippets", "Ftm");
                ...
                $snippetSelection = \TYPO3\CMS\Extbase\Utility\LocalizationUtility::translate($langPrefix."no_typoscript_snippet_exists", "Ftm");
            }
        }
        else {
            ...
            $syncHref.= '&amp;id='.$pid.'';
            $syncHref.= '&amp;tx_ftm_web_ftmftm[action]=loadSnippets';
            $syncHref.= '&amp;tx_ftm_web_ftmftm[controller]=TypoScriptSnippet';
            $noSnippetsLabel = \TYPO3\CMS\Extbase\Utility\LocalizationUtility::translate($langPrefix."no_saved_typoscript_snippet_exists", "Ftm");
            $syncLinkLabel = \TYPO3\CMS\Extbase\Utility\LocalizationUtility::translate($langPrefix."synchronize_typoscript_snippets_message", "Ftm");
