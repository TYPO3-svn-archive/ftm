        ...
        if(!empty($this->lessVariables)) {
            foreach($this->lessVariables as $variable) {
                ...
                if(!($lessVariable instanceof \CodingMs\Ftm\Domain\Model\TemplateLessVariable)) {
                    ...
                    $lessVariableObject->setVariableType(  $variable[2]);
                    $lessVariableObject->setVariableValue( $variable[3]);
                    $lessVariableObject->setVariableColor( $variable[4]);
                    $lessVariableObject->setVariableString($variable[5]);
