...
.. important:: **Achtung:** Ab Version 1.1.2 arbeitet der FTM mit der dyncss-Extension, damit auch SASS/SCSS optimal verwendet werden kann!



---------------------------------------
Allgemeines über dynamisches CSS im FTM
---------------------------------------
Der FTM verwendet für die verwendung von dynamischen CSS die Extension `dyncss <http://typo3.org/extensions/repository/view/dyncss>`_.
...
.. note:: *Achtung:* Aktuell werden nur dyncss_less und dyncss_scss unterstützt. Weitere werden auf Anfrage integriert.

Des Weiteren wird das FTM von Haus aus mit LESS Elements um eine Basis an nützlichen Mixins bereistellen zu können. 
Abschließend werden alle generierten CSS-Dateien mit Hilfe der ScriptMerger-Extension gemergt.
