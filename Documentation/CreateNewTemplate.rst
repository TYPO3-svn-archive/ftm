...
**8.** Laden Sie sich nun `Bootstrap 3 <http://getbootstrap.com` herunter und legen Sie es im Verzeichnis ``typo3conf/ext/ftm_theme_bootstrap/Resources/Public/Contrib/bootstrap`` ab.
